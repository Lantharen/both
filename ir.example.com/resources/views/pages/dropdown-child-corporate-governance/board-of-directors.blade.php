...
@section('page-title', 'Board of Directors :: Marathon Digital Holdings (MARA)')

@section('page-class', 'pg-107639 page-type-team pg-corporate-governance-board-of-directors ir has-sub-nav fl-builder-breakpoint-large')
                            ...
                            <div class="personnel-listing" id="board-of-directors">
                                <div class="member " id="fred-thiel">
                                    <div class="member-header">
                                        <h2>Fred Thiel</h2>
                                        <p class="title">Chief Executive Officer, Chairman of the Board of Directors</p>
                                    </div>
                                    <div class="" id="member-bio-3968" data-parent="#board-of-directors">
                                ...
                                <div class="member " id="georges-antoun">
                                    ...
                                    <div class="" id="member-bio-4012" data-parent="#board-of-directors">
                                        <div class="member-info">
                                            <div class="member-description">
                                ...
                                <div class="member " id="kevin-a-denuccio">
                                    ...
                                    <div class="" id="member-bio-3971" data-parent="#board-of-directors">
                                        <div class="member-info">
                                            <div class="member-description">
                                ...
                                <div class="member " id="sarita-james">
                                    ...
                                    <div class="" id="member-bio-4028" data-parent="#board-of-directors">
                                        <div class="member-info">
                                            <div class="member-description">
                                ...
                                <div class="member " id="jay-leupp">
                                    ...
                                    <div class="" id="member-bio-4013" data-parent="#board-of-directors">
                                        <div class="member-info">
                                            <div class="member-description">
                                ...
                                <div class="member " id="said-ouissal">
                                    ...
                                    <div class="" id="member-bio-4029" data-parent="#board-of-directors">
                                        <div class="member-info">
                                            <div class="member-description">
                                ...
                                <div class="member " id="doug-mellinger">
                                    ...
                                    <div class="" id="member-bio-4058" data-parent="#board-of-directors">
                                        <div class="member-info">
                                            <div class="member-description">
